...
export default function Profile() {
    ...
    const [name, setName] = React.useState<string>(globalName)
            ...
            <Container>
                <Box marginTop="50px" alignItems="center" display="flex" justifyContent="center" flexDirection="column">
                    ...
                    <div className="mt-10">
                        ...
                        <input style={{display: "none"}} id="image" name="image" type="file" accept="image/png, image/gif, image/jpeg" />
                    </div>
                    {/* <div className="mt-10">
                        <Typography  variant="h5" color="inherit">
